    ...
    <div className='w-full'>
      <div className="max-w-sm bg-white border border-gray-200 rounded-lg shadow ">
        ...
        <div className="p-5">
          ...
          <p className="mb-3 font-normal text-gray-700 ">{props.itemDesc}</p>
          <p className="text-xs text-gray-500 pb-2">By {props.author?props.author:"Unknown"} on {new Date(props.date).toGMTString()}</p>
          <a href={props.url} target='_blank' rel='noreferrer' className="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 ">
            Read more
